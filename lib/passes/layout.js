...
export function withLayout(template) {
  ...
  // Only a design that has never had a layout gets seeded; an empty element
  // list is a card the user cleared and must come back empty.
  if (Array.isArray(template.layout?.elements)) return template;
