...
// Stands in for a real attendee wherever a pass has to be shown before anyone
// has registered — the designer's canvas and the 3D showcase. The payload is
// deliberately not a real id, so a scan of the preview resolves to nothing.
