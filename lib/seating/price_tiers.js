...
//
// `hex` carries the same colour for the canvas renderer, which cannot resolve a
// class name. The two must stay in step — a band that reads rose in the legend
// and amber on the map is worse than no colour at all.
