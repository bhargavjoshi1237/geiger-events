...
--     genuinely runs past.
--   * Constructor logos come from en.wikipedia, not Commons — Commons only
--     carries 6 of the 11, so the set would be half monograms. Red Bull,
--     Mercedes and Haas use their genuine 2026 marks. These are non-free files
--     hotlinked for identification, which is what they are there for.
--
...
insert into events.events (
  ...
  $meta${
    ...
    "guests": [
      { "id": "g1", "image": "https://upload.wikimedia.org/wikipedia/en/thumb/f/fa/Red_Bull_Racing_Logo_2026.svg/500px-Red_Bull_Racing_Logo_2026.svg.png", "name": "Oracle Red Bull Racing", "role": "Max Verstappen · Isack Hadjar", "company": "Red Bull Ford Powertrains", "bio": "Verstappen has won here before and the long straight suits a low-drag Red Bull. First season running their own power unit in partnership with Ford." },
      { "id": "g2", "image": "https://upload.wikimedia.org/wikipedia/en/thumb/d/df/Scuderia_Ferrari_HP_logo_24.svg/500px-Scuderia_Ferrari_HP_logo_24.svg.png", "name": "Scuderia Ferrari HP", "role": "Charles Leclerc · Lewis Hamilton", "company": "Ferrari", "bio": "Leclerc took pole in Vegas in 2023 and 2024. Hamilton's second season in red, and Ferrari supply three teams on the 2026 grid." },
      { "id": "g3", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Mclaren_Logo_2021.svg/500px-Mclaren_Logo_2021.svg.png", "name": "McLaren Formula 1 Team", "role": "Lando Norris · Oscar Piastri", "company": "Mercedes", "bio": "The most recent constructors' champions, defending in a season where the rulebook was thrown out." },
      { "id": "g4", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Mercedes-AMG_Petronas_F1_Team_logo_%282026%29.svg/500px-Mercedes-AMG_Petronas_F1_Team_logo_%282026%29.svg.png", "name": "Mercedes-AMG Petronas F1 Team", "role": "George Russell · Kimi Antonelli", "company": "Mercedes", "bio": "Works Mercedes power in a regulation year built around the hybrid split — historically their strongest hand." },
      { "id": "g5", "image": "https://upload.wikimedia.org/wikipedia/en/1/15/Aston_Martin_Aramco_2024_logo.png", "name": "Aston Martin Aramco F1 Team", "role": "Fernando Alonso · Lance Stroll", "company": "Honda", "bio": "Adrian Newey's first full car for Silverstone, with works Honda power arriving for 2026." },
      { "id": "g6", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Atlassian_Williams_F1_Team_logo.svg/500px-Atlassian_Williams_F1_Team_logo.svg.png", "name": "Atlassian Williams Racing", "role": "Alex Albon · Carlos Sainz", "company": "Mercedes", "bio": "Grove's strongest driver pairing in two decades, on a circuit where straight-line speed pays." },
      { "id": "g7", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/BWT_Alpine_F1_Team_Logo.png/500px-BWT_Alpine_F1_Team_Logo.png", "name": "BWT Alpine F1 Team", "role": "Pierre Gasly · Franco Colapinto", "company": "Mercedes", "bio": "Now a customer team, trading the Renault works engine for Mercedes power from 2026." },
      { "id": "g8", "image": "https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/VCARB_F1_logo.svg/500px-VCARB_F1_logo.svg.png", "name": "Visa Cash App Racing Bulls", "role": "Liam Lawson · Arvid Lindblad", "company": "Red Bull Ford Powertrains", "bio": "The Faenza team with a rookie alongside Lawson, and the same power unit as the senior squad." },
      { "id": "g9", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Audi-Logo_2016.svg/500px-Audi-Logo_2016.svg.png", "name": "Audi F1 Team", "role": "Nico Hülkenberg · Gabriel Bortoleto", "company": "Audi", "bio": "Sauber becomes Audi — a full works entry from Ingolstadt, built for the 2026 rules from the ground up." },
      { "id": "g10", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/TGR_Haas_F1_Team_Logo_%282026%29.svg/500px-TGR_Haas_F1_Team_Logo_%282026%29.svg.png", "name": "TGR Haas F1 Team", "role": "Esteban Ocon · Oliver Bearman", "company": "Ferrari", "bio": "America's team, now running under Toyota Gazoo Racing colours, on American soil for the third time this season." },
      { "id": "g11", "image": "https://upload.wikimedia.org/wikipedia/en/thumb/b/bc/Cadillac_Formula_1_Team_Logo_%282025%29.svg/500px-Cadillac_Formula_1_Team_Logo_%282025%29.svg.png", "name": "Cadillac Formula 1 Team", "role": "Sergio Pérez · Valtteri Bottas", "company": "Ferrari", "bio": "The eleventh team. Two race winners in the cockpits for Cadillac's debut season, and a home Grand Prix in Vegas." }
    ],
