...
// Absent access is the shape every pre-existing row has. It resolves to the
// product's documented default (DEFAULT_ACCESS.free === true), so it grants
// rather than throwing. Gating a room means explicitly setting free: false.
