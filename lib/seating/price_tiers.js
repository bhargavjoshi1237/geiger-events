...
export const PRICE_SCALE = [
  ...
  // Appended, not reordered: an arena routinely prices in more than six bands
  // (level x side), and everything past the end of this scale used to collapse
  // into one indistinguishable colour. Maps with six bands or fewer are unchanged.
  { key: "p7", fill: "bg-indigo-400/15", stroke: "border-indigo-400/40", dot: "bg-indigo-400", hex: "#818cf8" },
  { key: "p8", fill: "bg-fuchsia-400/15", stroke: "border-fuchsia-400/40", dot: "bg-fuchsia-400", hex: "#e879f9" },
  { key: "p9", fill: "bg-lime-400/15", stroke: "border-lime-400/40", dot: "bg-lime-400", hex: "#a3e635" },
];
